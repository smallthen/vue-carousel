<template>
  <div class="vueCarousel carousel-container" :style="carouselContainer" @mouseenter="enter()" @mouseleave="leave()">
    ...
    <div href="javascript:;" class="carousel-arrow arrow-right" v-if="carouselOption.showCarouselArrow" @click="next()">&gt;</div>
  </div>
</template>
...
export default {
  ...
  computed: {
    carouselContainer(){
      return{
        width:this.carouselOption.carouselWidth+'px',height:this.carouselOption.carouselHeight+'px'
      }
    },
    carouselWrap() {
      return {
  ...
  .carousel-container .carousel-buttons-wrap {
    ...
    .carousel-container .carousel-buttons-wrap .carousel-buttons {
      ...
      .carousel-container .carousel-buttons-wrap .carousel-buttons .carousel-button {
        ...
        text-align: center;
        cursor: pointer; }
        .carousel-container .carousel-buttons-wrap .carousel-buttons .carousel-button:last-child {
          margin-right: 0; }
        .carousel-container .carousel-buttons-wrap .carousel-buttons .carousel-button.on {
